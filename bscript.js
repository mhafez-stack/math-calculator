...
// Value that is being shown. The default value is 0. The eval() method will take a string and run it. Our array will hold the buttons we are clicking,
// and we will later convert it to a string.
let displayVal = '0';
let pendingVal;  
let evalStringArray = []; 
